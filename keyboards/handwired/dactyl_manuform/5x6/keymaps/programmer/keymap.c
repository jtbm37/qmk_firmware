...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_5x6(
     ...
     DEV, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_DEL,
                      KC_EQUAL,KC_GRV,                                                       KC_RBRC, KC_EQL,
																		RAISE,LCTL_T(KC_ESC),                        KC_LSFT, KC_SPC,
																				KC_BSPC,ALTL,                         KC_LGUI, LOWER,  
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     _______,_______,_______,_______,_______,_______,                        KC_PSCREEN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,
